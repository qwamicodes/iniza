...
- [2026-09-07 tracked Git history secret scan](secret-scan-2026-09-07.md) records checksum-verified Gitleaks provenance, complete reachable-history scope, zero findings, and explicit limitations.
